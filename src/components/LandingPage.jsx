...
import { BookOpen, LogIn, MapPin, Clock, ChevronRight, MessageCircle, Users, Target, ShoppingBag, Pin, Smartphone, Star, Images, X, ChevronLeft, Zap } from 'lucide-react'
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Grupos pequeños, corrección técnica constante y maestros que potencian tu expresión en cada clase.',
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3987.0480449696374!2d-79.8962281!3d-2.1352448!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x902d6d14b05d22eb%3A0x9d1116860e1ea0f4!2sStudio%20Dancers!5e0!3m2!1ses!2sec!4v1772341545272!5m2!1ses!2sec"
                width="100%"
                height="200"
      ...
      >
        ...
        {/* Pulse ring — 3 cycles then stops */}
        <span className="absolute inset-0 rounded-full bg-green-400 opacity-30 pointer-events-none"
