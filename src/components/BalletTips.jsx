...
const PLAYLISTS = [
  ...
  },
  {
    id: 'clase',
    icon: Activity,
    title: 'Ballet Class · Søren Bebe',
    description: 'Más de 600 pistas para barra, centro y variaciones. Una de las más usadas por profesores.',
    accent: 'border-teal-400',
    iconColor: 'bg-teal-100 text-teal-600',
    url: 'https://open.spotify.com/playlist/54YFNBel9IEvKoLdWziySv',
  },
  {
    id: 'baby',
    icon: Sparkles,
